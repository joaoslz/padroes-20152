...
public class UsuarioStepBuilder {
	...
	// passos para construção do objeto
	...
	// classe interna Steps implementando TODAS as interfaces que representam os
	// passos
	private static class Steps
			implements NomeStep, CpfStep, DataNascimentoStep, EnderecoStep, 
